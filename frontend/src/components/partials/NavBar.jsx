    ...
    <>
      <nav className='w-screen h-20 flex justify-between items-center px-11 relative py-2 select-none'>
        ...
        <div className='flex h-full items-center w-52 bg-[#d9d9d99a] rounded-full px-1 justify-between'>
          <p className='ml-3 w-32 truncate font-semibold text-md '>USER_NAMEeeeeeee</p>
          <img src={process.env.PUBLIC_URL+'/images/bald-eagle-550804_1280.jpg'} alt="logo" className='w-14 h-14 rounded-full object-cover' />
        </div>
      </nav>
    </>
  )
